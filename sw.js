...
var CACHE_NAME = 'diamond-edge-v11';
var STATIC_ASSETS = [
  './',
  './index.html',
  './manifest.json',
...
self.addEventListener('fetch', function(event) {
  ...
  // MLB API and weather API — always go to network, don't cache
  if (url.indexOf('statsapi.mlb.com') !== -1 || url.indexOf('api.open-meteo.com') !== -1) {
